//
//  PreferencesControllerNotifications.m
//  Telephone
//
...
NSString * const AKPreferencesControllerDidChangeAccountEnabledNotification = @"AKPreferencesControllerDidChangeAccountEnabled";
